...
import {OptionDirective} from "../selector/directives/option.directive";
import {HighlightableDirective} from "../selector/directives/highlightable.directive";
import {SelectorDatasource} from "../selector/services/selector-datasource.service";
...
export class AutosuggestComponent implements OnDestroy, AfterViewInit {
...
*/
  ...
  selectOption(option: unknown): void {
    ...
    this.control.patchValue(controlValue.selected);
